...
os.chdir("c:\\Users\\suman.light\\Desktop\\Minor project\\Health_prophecy_using_ML\\")
...
# TESTING DATA
tr = pd.read_csv(r"C:\Users\suman.light\Desktop\Minor project\Health_prophecy_using_ML\Testing.csv")
...
root = Tk()
root.title("Health check up system")
root.configure()
...
w2 = Label(root, justify=LEFT, text="Health Prophecy Model")
...
lr =  Button(root, text="please check now",height=2, width=20, command=message)
